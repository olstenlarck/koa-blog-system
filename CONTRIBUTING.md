# Contributing to koa-blog-system

:sparkles: Thanks for your contribution in advance! :tada:

First and foremost, thank you! We appreciate that you want to contribute to `koa-blog-system`, your time is valuable, and your contributions mean a lot to us.
...
As a user of `koa-blog-system` you're the perfect candidate to help us improve our documentation. Typo corrections, error fixes, better explanations, more examples, etc. Open issues for things that could be improved. Anything. Even improvements to this document.

Use the [`docs` label](https://github.com/tunnckoCore/koa-blog-system/labels/docs) to find suggestions for what we'd love to see more documentation on.
...
The [`question` label](https://github.com/tunnckoCore/koa-blog-system/labels/question) is a good place to find ongoing discussions.
...
1. **version**: what version of `koa-blog-system` were you using when you experienced the bug?
